...
public class ClusterCommandExecutorUnitTests {
	...
	static final RedisClusterNode CLUSTER_NODE_1 = new RedisClusterNode(CLUSTER_NODE_1_HOST, CLUSTER_NODE_1_PORT,
			new SlotRange(0, 5460)).withId("ef570f86c7b1a953846668debc177a3a16733420");
	static final RedisClusterNode CLUSTER_NODE_2 = new RedisClusterNode(CLUSTER_NODE_2_HOST, CLUSTER_NODE_2_PORT,
			new SlotRange(5461, 10922)).withId("0f2ee5df45d18c50aca07228cc18b1da96fd5e84");
	static final RedisClusterNode CLUSTER_NODE_3 = new RedisClusterNode(CLUSTER_NODE_3_HOST, CLUSTER_NODE_3_PORT,
			new SlotRange(10923, 16383)).withId("3b9b8192a874fa8f1f09dbc0ee20afab5738eee7");
	...
	@Before
	public void setUp() {
		this.executor = new ClusterCommandExecutor(new MockClusterNodeProvider());
	}
	...
	class MockClusterNodeProvider implements ClusterNodeProvider {
